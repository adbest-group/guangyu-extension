        $("input[name='fanli_version']").val(localStorage["fanli_version"]);
		$("input[name='fanli_channel']").val(localStorage["fanli_channel"]);
		$("input[name='fanli_did']").val(localStorage["fanli_did"]);
        /*
		$.showPreloader();
		$.ajax({
				type : "post",
				url : lrkj_service_ip + "front/registerAction.jhtml",
